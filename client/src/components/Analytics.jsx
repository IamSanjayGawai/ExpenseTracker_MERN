...
const Analytics = ({ allTransactions }) => {
  ...
  return (
    <>
      <div className="row d-flex justify-content-center pt-1 px-4" style={{overflowY:'auto', height:'62vh'}}>
          ...
          <div className="card bx-sd4 " style={{height:'56vh'}}>
            <div className="card-header">
              <h4 className="card-title d-flex">
                Total Transactions: <h5 className="text-primary d-flex mt-1 mx-3">{totalTransaction}</h5>
              </h4>
            </div>
        ...
        <div className="col-12 col-sm-8  col-md-3 mb-4">
          <div className="card bx-sd4" style={{height:'56vh'}}>
            <div className="card-header ">
              <h4 className="card-title d-flex ">Total TurnOver: <h5 className="text-primary d-flex mt-1 mx-3">₹{totalTurnover}</h5></h4>
            </div>
            <div className="card-body mt-5">
                    ...
                    return (
                        ...
                        <div className="card mb-1">
                            <div className="card-body p-2 d-flex justify-content-between  align-items-center bx-sd4">
                                ...
                                <Progress percent={((amount/totalIncomeTurnover) * 100).toFixed(0)} style={{width:'70%'}} strokeColor={'lime'}/> 
                              </div>
                        </div>
                    )
                })
                ...
                categories.map(category => {
                    ...
                    return (
                        ...
                        <div className="card mb-1">
                            <div className="card-body p-2 d-flex justify-content-between align-items-center  bx-sd4">
                                <h6 className="text-capitalize">{category}</h6>
                                <Progress percent={((amount/totalIncomeTurnover) * 100).toFixed(0)} style={{width:'70%'}} strokeColor={'red'}/> 
                              </div>
                        </div>
                    )
                })
